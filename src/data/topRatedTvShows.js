const topRatedTvShows = [
	...
	},
	{
		...
		runtime: 57,
		year_started: 2011,
		genres: ["Fantasy", "Science-Fiction", "Drama", "Action", "Adventure", "Mystery", "War", "Science-fiction"],
		stars: [
			"Peter Dinklage",
			"Kit Harington",
	...
	},
	{
		...
		runtime: 22,
		year_started: 2013,
		genres: ["Animation", "Comedy", "Fantasy", "Science-Fiction", "Action", "Adventure", "Science-fiction"],
		stars: [
			"Chris Parnell",
			"Spencer Grammer",
			"Sarah Chalke",
	...
	},
	{
		...
		runtime: 42,
		year_started: 2021,
		genres: ["Animation", "Drama", "Fantasy", "Science-Fiction", "Action", "Adventure"],
		stars: [
			"Hailee Steinfeld",
			"Ella Purnell",
			"Kevin Alejandro",
	...
	},
	{
		...
		runtime: 86,
		year_started: 2002,
		genres: ["Drama", "Action", "Adventure", "Fantasy", "Science-Fiction", "Science-fiction", "Western"],
		stars: [
			"Nathan Fillion",
			"Gina Torres",
			"Alan Tudyk",
	...
	},
	{
		...
		runtime: 24,
		year_started: 2011,
		genres: ["Animation", "Action", "Adventure", "Fantasy", "Science-Fiction", "Anime", "Comedy", "Drama"],
		stars: [
			"Megumi Han",
			"Mariya Ise",
			"Issei Futamata",
